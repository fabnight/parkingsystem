...
=======
	...
	public static final String GET_LAST_CLOSED_TICKET = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=?  order by t.OUT_TIME desc  limit 1";
>>>>>>> Stashed changes
}
